...
|-------|---------|--------|
| 0 | Test harness + scaffolding so we can TDD pure modules | ☐ |
| 1 | **Looks like pool**: render-from-state, correct pocket geometry, scaling that tracks canvas, Move Hole visibly moves | ☐ |
